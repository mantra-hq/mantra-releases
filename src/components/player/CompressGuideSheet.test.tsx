/**
 * CompressGuideSheet Tests - 压缩模式引导面板测试
 * Story 10.1: Task 6.3
...
import { CompressGuideSheet } from "./CompressGuideSheet";
...
describe("CompressGuideSheet", () => {
  ...
  it("should render sheet when open is true", () => {
    render(<CompressGuideSheet {...defaultProps} />);
  ...
  it("should not render sheet when open is false", () => {
    render(<CompressGuideSheet {...defaultProps} open={false} />);
